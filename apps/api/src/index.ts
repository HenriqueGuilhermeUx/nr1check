...
import { registerNexOfficeIntegration } from "./integrations/nexoffice";
...
async function startServer() {
  ...
  app.use(
    cors({
      ...
      credentials: true,
      allowedHeaders: ["content-type", "authorization", "x-trpc-source", "x-nexoffice-key"],
  ...
  registerNexOfficeIntegration(app);
